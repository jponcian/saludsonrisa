        ...
        <div class="card ss-card">
            ...
            <div class="card-header ss-card-header text-center p-4">
                ...
                <div class="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <img src="multimedia/somosb.jpg" alt="SomosSalud"

                        style="max-width:220px; max-height:70px; border-radius:16px; box-shadow:0 4px 16px rgba(0,0,0,0.12); background:#fff; margin-bottom:12px; object-fit:contain;">

                    <p class="mb-0 fw-semibold"

                        style="font-size:1.15rem; color:#fff; text-shadow:0 2px 8px rgba(0,0,0,0.10);">Resumen de

                        Cobertura del Plan</p>
